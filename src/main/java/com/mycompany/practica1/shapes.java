...
public class shapes extends javax.swing.JFrame {
    ...
    pdfConverter util = new pdfConverter();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (choosed.showDialog(null, "Exportar objetos") == JFileChooser.APPROVE_OPTION) {
            ...
            try (PDDocument document = new PDDocument()) {
                ...
                util.convertPDF(pdfPath, path);
                System.out.println("PDF creado en: " + pdfPath);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
